...
export const mockProfiles: UserProfile[] = [
    {
        ...
        interests: ['✈️ Travel', '☕ Coffee', '🐕 Dogs', '📸 Photography'],
        distance: 3,
        location: 'Istanbul',
        isOnline: true,
        isPremium: false,
    ...
    },
    {
        ...
        name: 'Emma',
        age: 23,
        bio: 'Yoga lover 🧘 Beach vibes 🏖️ Artist at heart 🎨',
        photos: [generateAvatar('Emma', 1)],
        interests: ['🧘 Yoga', '🏖️ Beach', '🎨 Art', '🍷 Wine'],
        distance: 5,
        location: 'Ankara',
        isOnline: true,
        isPremium: true,
    ...
    },
    {
        ...
        name: 'Isabella',
        age: 26,
        bio: 'Dancing through life 💃 Wine lover 🍷 Travel bug ✈️',
        photos: [generateAvatar('Isabella', 4)],
        interests: ['💃 Dancing', '🍷 Wine', '✈️ Travel', '🎪 Festivals'],
        distance: 2,
        location: 'Antalya',
        isOnline: false,
        isPremium: true,
    ...
    },
    {
        ...
        name: 'Charlotte',
        age: 28,
        bio: 'Hiking enthusiast ⛰️ Dog person 🐕 Gamer 🎮',
        photos: [generateAvatar('Charlotte', 6)],
        interests: ['⛰️ Hiking', '🐕 Dogs', '🎮 Gaming', '🎯 Sports'],
        distance: 7,
        location: 'Istanbul',
        isOnline: true,
        isPremium: false,
...
export const mockMessages: Message[] = [
    ...
    { id: 'msg15', senderId: 'me', text: 'The tapas were incredible! 🍽️ You should definitely go', timestamp: new Date(Date.now() - 1000 * 60 * 10).toISOString(), read: true, type: 'text' },
...
export const mockCurrentUser: UserProfile = {
    ...
    interests: ['🎵 Music', '✈️ Travel', '🍳 Cooking', '🎮 Gaming', '📸 Photography', '☕ Coffee'],
    distance: 0,
    location: 'Istanbul',
    isOnline: true,
    isPremium: false,
